  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
		<form action="process.php?action=quickCreate" method="POST">
		...
		<div class="form-group input-group">
			<span class="input-group-addon">Proctor</span>
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer" style="text-align: center;">
        <button type="button" class="btn btn-danger"
				onclick="location.href='process.php?action=removeExam&date=<?=$date?>&id=<?=getExamId($room, $date, $timeFrom)?>'">
				Yes</button>
